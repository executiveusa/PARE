---
name: pare-completion-gates
description: Convert acceptance criteria into runnable or explicitly manual evidence gates before substantial work begins so PARÉ cannot claim completion without observed proof.
triggers:
  - "completion gates"
  - "definition of done"
  - "acceptance criteria"
